...
private package SparkPass.Crypto.Argon2id.Index is
   ...
   procedure Initialize_Address_Generator (
      ...
      Post   => State.Counter = 0 and
                ...
                State.Input_Block(6) = 1;     -- First address block generated
   --  Post: Input block initialized, first address block pre-generated
