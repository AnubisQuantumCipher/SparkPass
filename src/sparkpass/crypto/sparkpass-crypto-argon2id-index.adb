...
with SparkPass.Crypto.Argon2id.Mix;
with Interfaces; use Interfaces;

package body SparkPass.Crypto.Argon2id.Index with
   SPARK_Mode => On
is
   ...
   begin
      ...
      --  SparkPass: p = 1 (single lane), so ref_lane always = 0
   ...
   begin
      ...
      if Pos.Pass = 0 and Pos.Segment = 0 then
         ...
         SparkPass.Crypto.Argon2id.Mix.G (
            X      => Zero_Block_Local,
            Y      => State.Input_Block,
...
end SparkPass.Crypto.Argon2id.Index;
