...
private package Spark_Argon2id.Index is
   ...
   function Calculate_Reference_Area_Size (
      ...
      Global => null,
      Pre    => Index < Blocks_Per_Segment and
      ...
      Post   => Calculate_Reference_Area_Size'Result > 0 and
                Calculate_Reference_Area_Size'Result <= Blocks_Per_Lane;
   ...
   function Calculate_Ref_Index (
      ...
      Pre    => Index < Blocks_Per_Segment and then
                Relative_Position < Blocks_Per_Lane and then
                ...
                Relative_Position < Calculate_Reference_Area_Size (Pos, Index, Same_Lane, Blocks_Per_Segment, Blocks_Per_Lane),
   ...
   procedure Initialize_Address_Generator (
      ...
      Post   => State.Counter = 0 and
                ...
                State.Input_Block(3) = U64 (Total_Blocks) and
                State.Input_Block(4) = U64 (Iterations_V) and
                State.Input_Block(5) = 2 and  -- Argon2id type identifier
                State.Input_Block(6) = (if Pos.Pass = 0 and Pos.Segment = 0 then 1 else 0);
   --  Post: Input block initialized; first address block pre-generated only for pass=0, segment=0
   ...
   procedure Calculate_Reference (
      ...
      Post   => Ref_Lane in Lane_Index and
                ...
                Ref_Index /= (Pos.Segment * Blocks_Per_Segment + Index) and
                (if Pos.Pass = 0 and Pos.Segment = 0 then
   ...
   function Ref_Index_Valid (
      ...
      (Ref_Index in Block_Index and
       ...
       Ref_Index /= Block_Index'Min (Pos.Segment * Blocks_Per_Segment + Index,
                                      Block_Index'Last) and
